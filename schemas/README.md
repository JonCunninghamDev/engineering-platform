...
- `execution-envelope-v1.schema.json` defines the bounded consumer execution authority passed to a replaceable worker, including an immutable base commit, branch route, scope, actions, checks, human gates, budgets, and an explicit prohibition on release writes.
